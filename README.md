...
- [Echart Sphere 介绍](#echart-sphere-介绍)
  - [目录](#目录)
  - [特性](#特性)
  - [安装](#安装)
  - [快速上手](#快速上手)
  ...
  - [Props 说明](#props-说明)
    ...
    - [styleOptions](#styleoptions)
      - [`styleOptions` 是一个对象，用于自定义图表的样式。它包含了一系列属性，这些属性与全局配置的属性同名，允许您在单个图表级别上覆盖全局样式设置。这些属性包括但不限于颜色方案、字体大小、边距等。](#styleoptions-是一个对象用于自定义图表的样式它包含了一系列属性这些属性与全局配置的属性同名允许您在单个图表级别上覆盖全局样式设置这些属性包括但不限于颜色方案字体大小边距等)
  - [扩展图表类型](#扩展图表类型)
    - [X 轴类型扩展](#x-轴类型扩展)
    - [Y 轴类型扩展](#y-轴类型扩展)
    - [Grid 类型扩展](#grid-类型扩展)
    - [Tooltip 类型扩展](#tooltip-类型扩展)
    - [Legend 图例类型扩展](#legend-图例类型扩展)
    - [Series 类型扩展](#series-类型扩展)
    - [类型钩子](#类型钩子)
      - [beforeHook](#beforehook)
      - [afterHook](#afterhook)
      - [注意，"customXType"必须是已经存在的类型，afterHook 和 beforeHook 钩子才生效](#注意customxtype必须是已经存在的类型afterhook-和-beforehook-钩子才生效)
    - [图表类型扩展](#图表类型扩展)
- [Echart Sphere 示例](#echart-sphere-示例)
  ...
  - [多系列类型](#多系列类型)
    - [柱线混合](#柱线混合)
    - [柱线混合(自定义样式)](#柱线混合自定义样式)
  - [趋势图](#趋势图)
    - [柱形趋势图](#柱形趋势图)
    - [多系列趋势图](#多系列趋势图)
  - [饼图](#饼图)
    - [基础饼图](#基础饼图)
    - [带具体信息图例的饼图](#带具体信息图例的饼图)
    - [子母饼图](#子母饼图)
  - [散点图](#散点图)
    - [基础散点图](#基础散点图)
  - [雷达图](#雷达图)
...
通过设置`chartType`为`candlestick`，并且设置`candlestick`的开盘值，收盘值，最低值，最高值可以创建基础 K 线图
